            ...
            # 6. Payout Management
                ...
                while True:
                    ...
                    if payout_choice < 0 or payout_choice > 2:
                        ...
                        current_payout = p.GenerateTeacherPayout()
                    elif payout_choice == 2:
                        if current_payout:
                            p.SendPayoutEmail(current_payout)
                        else:
                            print("\n[-] Please generate payout data first (Press 1).\n")
                    else:
            ...
            # 7. Reports Management
                ...
                while True:
                 ...
                 if report_choice < 0 or report_choice > 2:
                    ...
                    if report_choice == 1:
                        r.BatchWiseLectureBetweenDates()
                    elif report_choice == 2:
                        r.BatchWiseLectureTotalAmount()
                    else:
                        print("Exit to main menu")
                        break

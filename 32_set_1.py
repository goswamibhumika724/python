fruits = {'apple','banana','mango','orange','pinapple','apple','grape','papaya','banana','strawberry','mango','kiwi','apple','orange','watermelon','grape','banana','peach','mango','apple','cherry','papaya','pinapple','banana','apple'}
print(fruits)
